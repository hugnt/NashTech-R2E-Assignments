...
namespace Assignment089.Persistence.Migrations
{
    ...
    [Migration("20250411114758_FixDatetimeSalary")]
    partial class FixDatetimeSalary
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Assignment089.Domain.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 4, 11, 18, 47, 56, 733, DateTimeKind.Local).AddTicks(4459),
                            Name = "Software Development",
                            UpdatedAt = new DateTime(2025, 4, 11, 18, 47, 56, 733, DateTimeKind.Local).AddTicks(4480)
                        },
                        new
                        {
                            Id = new Guid("9a4c6e2d-8f3b-4d1a-b5c7-2e9f0a1b3c4d"),
                            CreatedAt = new DateTime(2025, 4, 11, 18, 47, 56, 733, DateTimeKind.Local).AddTicks(4493),
                            Name = "Finance",
                            UpdatedAt = new DateTime(2025, 4, 11, 18, 47, 56, 733, DateTimeKind.Local).AddTicks(4496)
                        },
                        new
                        {
                            Id = new Guid("1b2c3d4e-5f6a-4e8b-9c0d-7a8b9e0f1c2d"),
                            CreatedAt = new DateTime(2025, 4, 11, 18, 47, 56, 733, DateTimeKind.Local).AddTicks(4504),
                            Name = "Accountant",
                            UpdatedAt = new DateTime(2025, 4, 11, 18, 47, 56, 733, DateTimeKind.Local).AddTicks(4505)
                        },
                        new
                        {
                            Id = new Guid("6d7e8f9a-0b1c-4d2e-a3b4-5c6d7e8f9a0b"),
                            CreatedAt = new DateTime(2025, 4, 11, 18, 47, 56, 733, DateTimeKind.Local).AddTicks(4514),
                            Name = "HR",
                            UpdatedAt = new DateTime(2025, 4, 11, 18, 47, 56, 733, DateTimeKind.Local).AddTicks(4516)
                        });
                });
